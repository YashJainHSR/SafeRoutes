<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableSessionState="True" CodeBehind="loggedin.aspx.cs" Inherits="TARPWEB.loggedin" %>
  ...
  <body>
      ...
      <asp:ScriptManager runat="server">
        ...
        <div class="body-content">
  	        <div class="jumbotron">
                  <center>
                <h3>SafeRoutes</h3>
                <p class="lead">Provides safest route between source and destination
                    <asp:Button ID="Button1" style="float:right;" runat="server" Text="Log Out" BorderStyle="Groove" CssClass="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" OnClick="Button1_Click"></asp:Button>
                </p>
                  </center>
  	        </div>
        </div>
    ...
    <div id="legend"style="display:inline-block;">
        <table>
            <tr>
                <td>
                    <img height="28" width="28" src="https://static9.depositphotos.com/1431107/1143/i/950/depositphotos_11437164-stock-photo-green-tick.jpg" />
                </td>
                <td>
                    Safest
                </td>
            ...
            <tr>
                <td>
                    <img height="28" width="28" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/SNice.svg/220px-SNice.svg.png" />
                </td>
                <td>
                    Safe
                </td>
            ...
            <tr>
                <td>
                    <img height="28" width="28" src="https://cdn3.iconfinder.com/data/icons/picons-weather/57/53_warning-256.png" />
                </td>
                <td>
                    Avoid
                </td>
            ...
            <tr>
                <td>
                    <img height="28" width="28" src="https://previews.123rf.com/images/tribalium123/tribalium1231604/tribalium123160400331/55366103-warning-x-sign.jpg" />
                </td>
                <td>
                    Dangerous
                </td>
            ...
            <tr>
                <td>
                    <img height="28" width="28" src="https://www.canada.ca/content/dam/hc-sc/migration/hc-sc/cps-spc/images/legislation/acts-lois/hazard-symbol-danger1.jpg" />
                </td>
                <td>
                    Exremely Dangerous
                </td>
      ...
      <div id="map" class="ui container"style="display:inline-block;float:left;height:100%;"></div>
    <div>
   	    <h6><b>Choose the path with the least danger index for a safe travel!</b></h6>
    </div>
    
    
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB6OH7gsywg8RRHUXdQ9fm79LRA8OxumyY&libraries=places"></script>
      ...
      AutocompleteDirectionsHandler.prototype.route = function() {
        ...
        this.directionsService.route({
         ...
         // size: new google.maps.Size(20, 32),
          ...
          var image2 = {
          url: 'https://previews.123rf.com/images/tribalium123/tribalium1231604/tribalium123160400331/55366103-warning-x-sign.jpg',
          // This marker is 20 pixels wide by 32 pixels high.
           scaledSize: new google.maps.Size(28, 28),
         // size: new google.maps.Size(20, 32),
...
dindex[k]+=4;
 ...
 div.innerHTML = '<ul class="msg"><li id='+colour+'></li><li id='+duration+'></li><li id='+distance+'></li><li id='+safetyi+'></li></ul>';
  document.getElementById(colour).innerHTML = "<hr>Route Number:  " + k + " is colored " +
      (color[k]) ;
